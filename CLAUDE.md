...
Planned modules (Milestone 7, see `LEDGER.md` and the project plan for the full roadmap): `confidence.py` (pure review-flag decision logic), `review.py` (review-flag persistence).
